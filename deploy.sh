...
curl --ftp-create-dirs -u "$1:$2" -T src/utils/Dectivator.php                ftp://$3/$4/src/utils/Deactivator.php
...
curl --ftp-create-dirs -u "$1:$2" -T vendor/composer/autoload_namespace.php  ftp://$3/$4/vendor/composer/autoload_namespace.php
curl --ftp-create-dirs -u "$1:$2" -T vendor/composer/autoload_prs4.php       ftp://$3/$4/vendor/composer/autoload_prs4.php
